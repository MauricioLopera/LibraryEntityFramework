<%@ Page Title="BD Autores | LibraryML" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="BDAutores.aspx.cs" Inherits="LibraryML.BDAutores" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row rowtit">
        <h4 class="left">Autores Disponibles</h4>
                    ...
                    <div class="col s12">
                        <div class="row rowsinmag">
                            <div class="input-field col s12">
                                <asp:TextBox ID="txtnomaut" runat="server" class="validate"></asp:TextBox>
                                <label for="txtnomaut">Nombre Completo</label>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="row rowsinmag rowconpad blue lighten-2">
        <div class="col s10">
            <div class="row rowsinmag">
                <asp:Label ID="label1" runat="server" Text="Nombre" CssClass="lbltitgrid"></asp:Label>
            </div>
        </div>
    </div>
    <div class="row rowsinmag">
        <asp:GridView ID="gridAutores" runat="server" CssClass="gridnopad" PageSize="300" HorizontalAlign="Center" EmptyDataText="No hay autores para mostrar" AutoGenerateColumns="False" ShowHeader="False" DataKeyNames="Id" AlternatingRowStyle-BackColor="#f5f5f5" OnRowCommand="gridAutores_RowCommand">
            <Columns>
                ...
                <asp:TemplateField HeaderText="id">
                    <ItemTemplate>
                        <asp:Label ID="lblidautor" runat="server" Text='<%# Bind("Id")%>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
